...
export default function PhoneTypesModal({
    defaults = {},
    onClose
}: {
    defaults?: any,
    ...
    async function submit() {
        ...
        try {
            ...
            const url = form.id
                ? `/api/tables/phones-types/${form.id}`
                : '/api/tables/phones-types'
            ...
            toast.success(
                form.id
                    ? 'Тип телефона успешно обновлен!'
                    : 'Тип телефона успешно добавлен!'
            )
            ...
            <div className="bg-white dark:bg-gray-dark rounded-lg shadow-lg w-[500px] p-7.5 max-h-[90vh] overflow-y-auto">
                <header className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-semibold">
                        {form.id ? 'Редактировать тип телефона' : 'Добавить тип телефона'}
                    </h3>
                ...
                <main className="space-y-4">
                    <InputGroup
                        label="Название"
                        placeholder="Например: iPhone 15, Samsung Galaxy S24"
                        type="text"
                        value={form.name}
                    ...
                    <InputGroup
                        label="Описание"
                        placeholder="Опциональное описание типа телефона"
                        type="textarea"
